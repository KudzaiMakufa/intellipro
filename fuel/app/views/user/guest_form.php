...
<div  align="center">
                        <a href="#top" class="navbar-logo" ><img src="<?php echo Uri::base(false);?>/assets/landing-theme/images/logopro.png" alt="INTELLIPRO" title="intellipro logo"></a>
                    </div>
					<br>
	<div class="col-md-8 col-md-offset-2">
		<div class="hero-content text-center landing-text-center">
		<h2 class="landing-h1" >Login to Intellipro</h2>
		</div>
	</div>
</div>
...
<div class="row form-actions text-center landing-text-center" style="margin-top: 20px;">
	...
	<a href=<?php echo Uri::base().'user/create' ; ?> >
		<button type="button" class="btn btn-success btn-lg btn-cta">Register</button>
	</a>
</div>
<div class="row form-actions text-center landing-text-center" style="margin-top: 20px;">
