  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel2">Pick New Role</h4>
      </div>
					...
					<?php foreach ($module as $item): ?>		
						<tr>
							...
							<div class="btn-toolbar">
								<div class="btn-group">
								<button type="button" class="btn btn-info btn-small" onclick="pickBranch2('<?php echo $item->name; ?>','<?php echo $item->id;; ?>')"> Pick
									</button>
								</div>
								</div>
...
<script>
	function pickBranch2(name,id)
	{
		document.getElementById('module_code').value=name;
		document.getElementById('module').value=id;
