...
<div class="row top_tiles">
              ...
              <a href="<?php echo Uri::create('depot/geo'); ?>">
                <div class="tile-stats">
                 <div class="icon"><i class="fa fa-map-marker"></i></div>
                  <div class="count"><?php echo 10 ; /*$kpi->countMarketPlaces()*/; ?></div>
                  <h3>Market Places </h3>
              ...
              <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
	              <a href="<?php echo Uri::create('user/farmers'); ?>">
	                <div class="tile-stats">
	                  ...
	                  <div class="count"><?php echo 10; /*$kpi->countFarmers()*/; ?></div>
	                  <h3>Farmers</h3>
              ...
              <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="tile-stats">
                  ...
                  <div class="count"><?php echo  10 /*$kpi->countProductsOnSale()*/; ?></div>
