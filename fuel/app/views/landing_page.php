...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo Uri::base(false);?>/assets/landing-theme/images/favicon.png" type="image/x-icon">
  ...
  <title><?php echo $title; ?> | INTELLIPRO</title>
</head>
<body>
...
<section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-after-navbar" id="header1-1" style="background-image: url(<?php echo Uri::base(false);?>/assets/landing-theme/images/background.png);">
